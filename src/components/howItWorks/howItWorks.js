    ...
    <div className={styles.howItWorksWrapper}>
        ...
        <div className={styles.iconWrapper}>
            ...
            <div className={styles.bidWrapper}>
                <img src={bidIcon} alt="register" className={styles.icon}/>
                <h3>MAKE A BID</h3>
            ...
            <div className={styles.learnWrapper}>
                <img src={learnIcon} alt="register" className={styles.icon}/>
                <h3>LEARN MORE</h3>
                <p>Learn more about the businesses that donated auction items and the non-profit organizations we will be donating to.</p>
            </div>
        </div>
        <p>Once the silent auction has closed, the person with the higest bid with be contacted with instructions on how to proceed with payment and where to send the item.</p>
    </div>
);
